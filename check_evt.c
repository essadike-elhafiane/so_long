...
/*   Updated: 2023/02/10 18:10:21 by eelhafia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cpy_s[i -1][j] == 'C' || cpy_s[i -1][j] == '0')
		cpy_s[i -1][j] = 'P';
	if (cpy_s[i +1][j] == 'C' || cpy_s[i +1][j] == '0')
		cpy_s[i +1][j] = 'P';
	if (cpy_s[i][j +1] == 'C' || cpy_s[i][j +1] == '0')
		cpy_s[i][j +1] = 'P';
	if (cpy_s[i][j -1] == 'C' || cpy_s[i][j -1] == '0')
		cpy_s[i][j -1] = 'P';
}
...
{
	if ((s[i +1][j] == 'C' || s[i +1][j] == '0' ||
		s[i -1][j] == 'C' || s[i -1][j] == '0') && (s[i][j] == 'P'))
		return (1);
	else if ((s[i][j +1] == 'C' || s[i][j +1] == '0' ||
		s[i][j -1] == 'C' || s[i][j -1] == '0') && (s[i][j] == 'P'))
		return (1);
	else
		return (0);
}
